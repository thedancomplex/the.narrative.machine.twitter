...
long calculate_feedrate_delay(long feedrate)
{
	//how long is our line length?
	long distance = sqrt(delta_units.x*delta_units.x + delta_units.y*delta_units.y + delta_units.z*delta_units.z);
	long master_steps = 0;
	...
	//return ((distance *   600000.0) / feedrate) / master_steps;	
